...
describe('vesselTile', function() {
  ...
  beforeEach(inject(function($httpBackend) {
	...
	it('should show the catch details', function() {
		var fishTripPanel = compile('<vessel-tile trip="trip"></vessel-tile>')(scope);
		scope.$digest();

    fishTripPanel.appendTo('#parent-container');
		expect(angular.element('.vessel-tile').length).toEqual(1);

    angular.element('vessel-tile').remove();
