...
angular.module('unionvmsWeb')
    .factory('userFeatureAccess', function($log, userService){
    ...
    var accessToAnyFeatureInList = function(application, featureList){
        ...
        if (!angular.isDefined(featureList)) {
            featureList = userFeatures;
        }
    ...
    return {
        accessToAnyFeatureInList: accessToAnyFeatureInList
    };
});
