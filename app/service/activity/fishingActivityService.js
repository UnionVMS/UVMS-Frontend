 ...
 */
angular.module('unionvmsWeb').factory('fishingActivityService', function (Departure, ArrivalNotification, Arrival, activityRestService, loadingStatus, FishingOperation) {
