...
describe('TranshipmentpanelCtrl with app states', function () {
    ...
    beforeEach(inject(function ($rootScope, $controller, _$state_, $httpBackend) {
        ...
        $state = _$state_;
        scope = $rootScope.$new();
        ctrl = $controller('TranshipmentpanelCtrl', { $scope: scope });
    }));
...
describe('TranshipmentpanelCtrl', function() {
    ...
    describe('Standard loading of the transhipment', function(){
        ...
        it('should initialize the transhipment by calling the rest service', inject(function() {
    ...
    describe('Loading of the transhipment by faHistoryNavigator', function(){
        beforeEach(inject(function($rootScope, $controller) {
            buildMocks();
        ...
        it('should initialize the transhipment through faHistoryNavigator', inject(function() {
