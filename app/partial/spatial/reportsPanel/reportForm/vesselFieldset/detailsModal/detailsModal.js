...
*/
angular.module('unionvmsWeb').controller('DetailsmodalCtrl',function($scope, $uibModalInstance, $q, $timeout, itemForDetail, vesselRestFactory, vesselRestService, SavedSearchGroup, GetListRequest){
