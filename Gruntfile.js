...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jsdoc: {
        dist: {
            src: ['app/service/common/*.js', 'app/service/spatial/*.js', 'app/service/reporting/*.js', 'app/service/areas/*.js', '!app/service/common/auth/*.js', 'app/partial/spatial/**/*.js', '!*-spec.js'],
            options: {
