 ...
 */
angular.module('unionvmsWeb').factory('Trip',function(locale,unitConversionService,tripReportsTimeline,fishingActivityService, tripDataHelperService) {
    ...
    var getRemarks = function(report){
        ...
        if(report.activityType === 'DEPARTURE' || report.activityType === 'FISHING_OPERATION'){
            ...
            if(report.activityType === 'ARRIVAL' && report.faReportDocumentType === 'DECLARATION' && report.fluxCharacteristics[0] && report.fluxCharacteristics[0].valueDateTime) {
