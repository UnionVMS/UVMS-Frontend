...
describe('JointfishingoperationpanelCtrl with app states', function () {
...
describe('JointfishingoperationpanelCtrl', function() {
    ...
    describe('Standard loading of the joint fishing operation', function(){
        ...
        it('should initialize the joint fishing operation by calling the rest service', inject(function() {
    ...
    describe('Loading of the joint fishing operation by faHistoryNavigator', function(){
        beforeEach(inject(function($rootScope, $controller) {
            buildMocks();
        ...
        it('should initialize the joint fishing operation through faHistoryNavigator', inject(function() {
