...
describe('RelocationpanelCtrl with app states', function () {
    ...
    beforeEach(inject(function ($rootScope, $controller, _$state_, $httpBackend) {
        ...
        $state = _$state_;
        scope = $rootScope.$new();
        ctrl = $controller('RelocationpanelCtrl', { $scope: scope });
    }));
...
describe('RelocationpanelCtrl', function() {
    ...
    describe('Standard loading of the relocation', function(){
        ...
        it('should initialize the relocation by calling the rest service', inject(function() {
    ...
    describe('Loading of the relocation by faHistoryNavigator', function(){
        beforeEach(inject(function($rootScope, $controller) {
            buildMocks();
        ...
        it('should initialize the relocation through faHistoryNavigator', inject(function() {
